...
If you haven't set your wifi details in the code, on startup it will prompt you to enter them on the serial terminal (115200 baud) and then save them so you don't have to do it again. Once it's connected to your network, you should be able to open the UI in your web browser by just typing "sdl.local" in the URL bar. 
