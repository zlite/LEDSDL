...
Load code onto ESP32 with Platormio (change the port in the ini file to whatever your ESP32 shows up as). If you haven't set your wifi details in the code, it will prompt you to enter then on the serial terminal (115200 baud). Alternatively, you can just load the file on the ESP32 using the Arduino IDE.
